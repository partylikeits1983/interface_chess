          ...
          <VStack align="start" spacing={2}>
            <HStack>
              ...
              <Text fontSize="md" fontWeight="semibold">
                Player {wagerPlayers?.player0}: <chakra.span color="green.500">{wagerStatus.winsPlayer0} Wins</chakra.span>
              </Text>
            </HStack>
            <HStack>
              <Icon as={FaUserCircle} color="red.500" />
              <Text fontSize="md" fontWeight="semibold">
                Player {wagerPlayers?.player1}: <chakra.span color="green.500">{wagerStatus.winsPlayer1} Wins</chakra.span>
              </Text>
            </HStack>
          </VStack>
        </>
